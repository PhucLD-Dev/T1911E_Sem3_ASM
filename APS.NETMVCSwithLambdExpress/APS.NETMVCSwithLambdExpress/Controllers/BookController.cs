...
using APS.NETMVCSwithLambdExpress.Context;
using APS.NETMVCSwithLambdExpress.Models;

namespace APS.NETMVCSwithLambdExpress.Controllers
{
    public class BookController : Controller
    {
        ...
        {
            var books = db.Book.Where(b => b.Published >= new DateTime(1990, 1, 1));
            return View(books);
        }
        public ActionResult ShowAfter2000()
        {
            var books = db.Book.Where(b => b.Published >= new DateTime(2000, 1, 1));
            return View(books);
        }
        // GET: Book/Details/5

#pragma checksum "C:\Users\phuch\source\repos\xBindingDataExample\xBindingDataExample\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "EFEC96F68CBBAF1E61AF2B9A8A09A418"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace xBindingDataExample
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj3_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::xBindingDataExample.Models.Book1 dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::xBindingDataExample.Models.Book1) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::xBindingDataExample.Models.Book1)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::xBindingDataExample.Models.Book1 obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::xBindingDataExample.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::xBindingDataExample.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::xBindingDataExample.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Books(global::System.Collections.Generic.List<global::xBindingDataExample.Models.Book1> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {

#pragma checksum "C:\Users\phuch\source\repos\T1911E_Sem3_ASM\DesignWeatherAPI\DesignWeatherAPI\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "873271F5CB3CEC396CFDC520A538A046"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace DesignWeatherAPI
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::DesignWeatherAPI.Models.DailyForecast dataRoot;
            ...
            {
                if (lineNumber == 124 && columnNumber == 36)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::DesignWeatherAPI.Models.DailyForecast) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::DesignWeatherAPI.Models.DailyForecast)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::DesignWeatherAPI.Models.DailyForecast obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_Day(global::DesignWeatherAPI.Models.Day obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature(global::DesignWeatherAPI.Models.Temperature1 obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature_Maximum(global::DesignWeatherAPI.Models.Maximum obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature_Minimum(global::DesignWeatherAPI.Models.Minimum obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj11_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::DesignWeatherAPI.Models.WeatherJSON dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 93 && columnNumber == 33)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::DesignWeatherAPI.Models.WeatherJSON) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::DesignWeatherAPI.Models.WeatherJSON)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::DesignWeatherAPI.Models.WeatherJSON obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature(global::DesignWeatherAPI.Models.Temperature obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::DesignWeatherAPI.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 115 && columnNumber == 13)
                {
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::DesignWeatherAPI.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::DesignWeatherAPI.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_WeatherEachDays(global::System.Collections.ObjectModel.ObservableCollection<global::DesignWeatherAPI.Models.DailyForecast> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_WeatherEachHours(global::System.Collections.ObjectModel.ObservableCollection<global::DesignWeatherAPI.Models.WeatherJSON> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
